  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-header pb-0">
        <div class="d-lg-flex">
          <div>
            <h5 class="mb-0">Daily Offers</h5>
          </div>
          <div class="ms-auto my-auto mt-lg-0 mt-4">
            <div class="ms-auto my-auto">
              <a href="{{ url('/dailyoffer/add') }}" class="btn bg-gradient-info btn-sm mb-0">+&nbsp; ADD NEW</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <table class="table table-flush" id="data-list">
            ...
            <tbody>
              ...
              <tr id="{{$item->id}}">
                ...
                <td class="text-sm"><a href="{{$item->link}}" target="_blank" class="text-info">View URL</a></td>
                <td class="text-sm">{{$item->views}}/{{$item->task_limit}}</td>
                <td class="text-sm" data-bs-toggle="tooltip" data-bs-original-title="{{$item->country}}">{{ \Illuminate\Support\Str::limit(strip_tags($item->country), 30, $end='...') }}</td>
                ...
                <td class="text-sm">
                  <a href="{{ url('dailyoffer/edit/' . $item->id) }}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                    <i class="fas fa-edit text-success"></i>
                  </a>
                  <a href="#" data-id="dailyoffer" id="{{$item->id}}" class="mx-3 delete" data-bs-toggle="tooltip" data-bs-original-title="Delete">
          ...
          <div class="d-flex" style="margin-left: 30px;">
            ...
            <div class="dropdown d-inline " style="margin-left: 10px;">
              ...
              <ul class="dropdown-menu dropdown-menu-lg-start px-2 py-3" aria-labelledby="navbarDropdownMenuLink2" data-popper-placement="left-start">
                <li><a class="dropdown-item border-radius-md" href="javascript:;" id="enable" data-id="dailyoffer">Eanble Task</a></li>
                <li><a class="dropdown-item border-radius-md" href="javascript:;" id="disable" data-id="dailyoffer">Disable Task</a></li>
              </ul>
            </div>
