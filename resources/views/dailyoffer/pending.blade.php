  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-header pb-0">
        <div class="d-lg-flex">
          <div>
            <h5 class="mb-0">Pending Daily offer Approval</h5>
          </div>
            ...
            <tbody>
              ...
              <tr id="{{$item->id}}">
                ...
                <td class="text-sm">
                  ...
                  <a href="{{ url('dailyoffer/approve/' . $item->id) }}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Approve">
                    <i class="fas fa-check-square text-success"> Approve</i>
                  </a>
                  <a href="#"  class="reject_dailyoffer" id="{{$item->id}}" class="mx-3 delete" data-bs-toggle="tooltip" data-bs-original-title="Reject Delete">
                    <i class="fas fa-trash text-danger"> Reject</i>
                  </a>
                </td>
              </tr>
              @endforeach
