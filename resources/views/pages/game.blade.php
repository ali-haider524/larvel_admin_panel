  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-header pb-0">
        <div class="d-lg-flex">
          <div>
            <h5 class="mb-0">PlayZone</h5>
          </div>
          <div class="ms-auto my-auto mt-lg-0 mt-4">
          <div class="ms-auto my-auto">
                <a href="#" class="btn bg-gradient-info addGame btn-sm mb-0">+&nbsp; ADD NEW</a>
              </div>
          </div>
        </div>
      </div>
              ...
              <tr id="{{$item->id}}">
                ...
                <td class="text-sm">
                     <span class="my-2 text-xs">
                        <img src="{{ url('images/games/'.$item->image) }}" class="avatar avatar-xl shadow">
                    </span>
                </td>
                ...
                <td class="text-sm">
                  <a href="#" class="mx-3 editGame" id="{{$item->id}}" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                    <i class="fas fa-edit text-success"></i>
                  </a>
                  <a href="#"  data-id="game"  id="{{$item->id}}"  class="mx-3 delete" data-bs-toggle="tooltip" data-bs-original-title="Delete">
          ...
          <button class="btn btn-outline-dark sub_chk_all"> Select All </button>
            <div class="dropdown d-inline " style="margin-left: 10px;">
              ...
              <ul class="dropdown-menu dropdown-menu-lg-start px-2 py-3" aria-labelledby="navbarDropdownMenuLink2" data-popper-placement="left-start">
                <li><a class="dropdown-item border-radius-md" href="javascript:;" id="enable" data-id="game">Eanble</a></li>
                <li><a class="dropdown-item border-radius-md" href="javascript:;" id="disable" data-id="game">Disable</a></li>
              </ul>
            </div>
         ...
         $.ajax({
            ...
            success: function (data) {
              $("#gameupdateModal").modal('show');
                 $("#gameid").val(data[0]['id']);
                 $("#gamelink").val(data[0]['link']);
                 $("#title").val(data[0]['title']);
                 $("#gameicon").val(data[0]['image']);
