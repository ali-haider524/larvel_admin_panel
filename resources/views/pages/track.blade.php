    ...
    <div class="row mb-5">
        <div class="col-lg-3">
            <div class="card position-sticky top-1">
                <ul class="nav flex-column bg-white border-radius-lg p-3">
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body updateUserBal" data-scroll="" href="#addcoin" id="{{$user->cust_id}}">
                            <div class="icon me-2">
                            ...
                            <span class="text-sm">Add COIN</span>
                        </a>
                    </li>
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body sendnoti" data-scroll="" href="#notifications"  id="{{$user->cust_id}}">
                            <div class="icon me-2">
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body updateUserStatus" data-scroll="" href="#" id="{{$user->cust_id}}" data-id="{{$user->status}}">
                            <div class="icon me-2">
                                <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <span class="text-sm">Ban User</span>
                        </a>
                    </li>
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body" data-scroll="" href="/clear_history/{{$user->cust_id}}">
                            <div class="icon me-2">
                                <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>settings</title>
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="text-sm">Delete All History</span>
                        </a>
                    </li>
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body delete" data-scroll="" data-id="usertrack"  id="{{$user->cust_id}}" >
                            <div class="icon me-2">
        ...
        <div class="col-lg-9 mt-lg-0 mt-4">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-sm-auto col-4">
                        <div class="avatar avatar-xl position-relative">
                            @if($user->type==null)
                            <img src="{{url('/images/user/userpro.png')}}" alt="bruce" class="w-100 border-radius-lg shadow-sm">
                            @elseif($user->type=="google")
                            @if($user->profile=='null')
                            <img src="{{url('/images/user/userpro.png')}}" alt="bruce" class="w-100 border-radius-lg shadow-sm">
                            @else
                            <img src="{{$user->profile}}" alt="bruce" class="w-100 border-radius-lg shadow-sm">
                            @endif
                            @else
                            <img src="{{url('/images/user/'.$user->profile)}}" alt="bruce" class="w-100 border-radius-lg shadow-sm">
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-auto col-8 my-auto">
                        <div class="h-100">
                            ...
                            <p class="mb-0 font-weight-bold text-sm">
                                Joined : {!!date('d-M-y H:i:s',strtotime($user->inserted_at))!!}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                <input id="firstName" class="form-control" type="text" value="{{$user->name}}" readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <label class="form-label">Email</label>
                            <div class="input-group">
                                <input id="firstName" class="form-control" type="text" value="{{$user->email}}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4 col-6">
                            ...
                            <input id="firstName" class="form-control" type="text" value="{{$user->cust_id}}" readonly>
                        </div>
                        <div class="col-sm-4 col-6">
                            <label class="form-label mt-4">COIN</label>
                            <input id="firstName" class="form-control" type="text" value="{{number_format($user->balance)}}" readonly>
                        </div>
                        <div class="col-sm-4 col-6">
                            <label class="form-label mt-4">Account Status</label>
                            @if($user->status==0)
                            <input id="firstName" class="form-control" type="text" value="ACTIVE" readonly>
                            @else
                            <input id="firstName" class="form-control" type="text" value="DISABLED" readonly>
                            @endif
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4 col-4">
                            ...
                            <input id="firstName" class="form-control" type="text" value="{{$user->country}}" readonly>
                        </div>
                        <div class="col-sm-4 col-6">
                            <label class="form-label mt-4">Account IP</label>
                            <input id="firstName" class="form-control" type="text" value="{{$user->ip}}" readonly>
                        </div>
                        <div class="col-sm-4 col-6">
                            <label class="form-label mt-4">Joined On</label>
                            <input id="firstName" class="form-control" type="text" value="{{$user->inserted_at}}" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <label class="form-label mt-4">Account Type</label>
                            <div class="input-group">
                                <input id="firstName" class="form-control" type="text" value="{{$user->type}}" readonly>
                            </div>
                        </div>
                        <div class="col-4">
                            <label class="form-label mt-4">Last Login</label>
                            <div class="input-group">
                                <input id="firstName" class="form-control" type="text" value="{{$user->updated_at}}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                            <label class="form-label mt-4">Account Banned Date</label>
                            <div class="input-group">
                                <input id="firstName" class="form-control" type="text" value="{{$user->banned_time}}" readonly>
                            </div>
                        </div>
                        <div class="col-9">
                            <label class="form-label mt-4">Account Banned Reason</label>
                            <div class="input-group">
                                <input id="firstName" class="form-control" type="text" value="{{$user->reason}}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-flush" id="category-list">
                            ...
                            <tbody>
                                ...
                                <tr id="{{$item->request_id}}">
                                    <td class="text-sm">{{$item->request_id}}</td>
            ...
            <div class="card mt-4" id="activity">
                ...
                <div class="card-body pt-0">
                    <div class="table-responsive">
                        <table class="table table-flush" id="activitylist">
                            <thead class="thead-light">
                                <tr>
                                    <th>TRANS ID</th>
                                    <th>COIN</th>
