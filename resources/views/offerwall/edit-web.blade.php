            ...
            <div class="col-lg-9 col-12 mx-auto">
                ...
                <div class="card mt-4" id="basic-info">
                    ...
                    <div class="card-body pt-0">
                        <form action="/offerwall/web/update" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control"  name="offer_slug" type="text" value="{{$data->offer_slug}}"  placeholder="Cpalead,Offerwall" readonly="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control"  name="description"  value="{{$data->description}}" type="text" placeholder="Best Offers etc" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control"  name="offerwall_url" type="text"  value="{{$offerwall_url}}"  placeholder="https://fastrsrvr.com/list/452511" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control"  name="header" value="{{$header}}" type="text" placeholder="Authorization: Bearer">
                                    </div>
                                </div>
